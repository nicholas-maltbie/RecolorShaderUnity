...
This example concerns Scene `3 - Recoloring Images` in the `Assets/Samples/3 - Recoloring Images`
...
`3 - Image Shader` and is saved at `3 - Recoloring Images/3 - ImageShader.shadergraph`. As mentioned earlier, this shader has
